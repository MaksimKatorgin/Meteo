#Согласно ГОСТу 30494-2011 освещенность в офисе должна быть 300-600 lx.  Для теплого времени года температура должна быть 23-25 °С,
#влажность 30-60 %, атмосферное давление 760 мм. рт. ст.  Для холодного:  температура - 22-24 °С, влажность 30-45 %, атмосферное давление 747-749 мм. рт. ст. 
#данная программа определяет дату и время, считывает показания с датчиков, определяет нормы в сотвествии из сезана и заносит их в электронную таблицу
import csv
import gpioexp
import time
import smbus
