...
while(True):
    time.sleep(0.5)
    if pressure<747:
        print("Атмосферное давение : %.2f mm Hg", pressure, "-ниже нормы")
    if 747<=pressure<=749:
        print("Атмосферное давение : %.2f mm Hg", pressure, "-норма")
    if pressure>749:
        print("Атмосферное давение : %.2f mm Hg", pressure, "-выше нормы")
    time.sleep(0.5)